...
<template>
  <div id="dashboard-analytics">
    ...
    <div class="vx-col w-full">
      <div class="vx-col w-full lg:w-1/1 mb-base">
        <vx-card slot="no-body" class="text-center bg-primary-gradient greet-user">
          <h1 class="mb-6 text-white">You have logged-In Finance Department,</h1>
          <p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">Tripcarte.Asia progress <strong>{{ checkpointReward.progress }}</strong> more sales today. Check your new badge in your profile.</p>
        </vx-card>
        </div>
        </div>
    ...
    <div>-----Tripcarte.Asia Finance Dashboard Prototype Development Ver-0.0.1</div>
